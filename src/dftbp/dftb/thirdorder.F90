...
module dftbp_dftb_thirdorder
  ...
  contains
    ...
    procedure :: getShiftNonvariationalDeriv ! TODO - is this procedure necessary?
...
contains
  ...
  subroutine updateCoordsCP_backup(this, neighList, species, coords, iAt, iCart)
    ...
    if (size(this%gamma3abDeriv, dim=3) < maxval(this%nNeighMax) + 1) then
      if (allocated(this%gamma3abDeriv)) then
        deallocate(this%gamma3abDeriv)
      end if
      if (allocated(this%gamma3baDeriv)) then
        deallocate(this%gamma3baDeriv)
      end if
      allocate(this%gamma3abDeriv(this%mShells, this%mShells, 0:maxval(this%nNeighMax), this%nAtoms))
      allocate(this%gamma3baDeriv(this%mShells, this%mShells, 0:maxval(this%nNeighMax), this%nAtoms))
      write (*,*) "shape of gamma3abDeriv is ", shape(this%gamma3abDeriv)
    end if
    ...
    do iAt1 = 1, this%nAtoms
      ...
      do iNeigh = 0, this%nNeighMax(iAt1)
        ...
        if (iNeigh <= this%nNeigh(iSp2, iAt1)) then
          ...
          do iSh1 = 1, this%nShells(iSp1)
            do iSh2 = 1, this%nShells(iSp2)
              this%gamma3abDeriv(iSh2, iSh1, iNeigh, iAt1) = rab(iCart) / dist * gamma3pR(this%UU(iSh1, iSp1),&
                  & this%UU(iSh2, iSp2), this%dUdQ(iSh1, iSp1), dist, lDamping, this%dampExp)
              this%gamma3baDeriv(iSh2, iSh1, iNeigh, iAt1) = rab(iCart) / dist * gamma3pR(this%UU(iSh2, iSp2),&
  ...
  subroutine updateCoordsCP(this, species, coords, iAt, iCart)
    ...
    do iAt1 = 1, this%nAtoms
      ...
      do iAt2 = 1, this%nAtoms
        ...
        do iSh1 = 1, this%nShells(iSp1)
          do iSh2 = 1, this%nShells(iSp2)
            this%gamma3abDeriv(iSh2, iSh1, iAt2, iAt1) = rab(iCart) / dist * gamma3pR(this%UU(iSh1, iSp1),&
                & this%UU(iSh2, iSp2), this%dUdQ(iSh1, iSp1), dist, lDamping, this%dampExp)
            this%gamma3baDeriv(iSh2, iSh1, iAt2, iAt1) = rab(iCart) / dist * gamma3pR(this%UU(iSh2, iSp2),&
                & this%UU(iSh1, iSp1), this%dUdQ(iSh2, iSp2), dist, lDamping, this%dampExp)
          end do
        end do
  ...
  subroutine updateChargesCP_backup(this, species, neighList, img2CentCell)
        ...
        do iSh1 = 1, this%nShells(iSp1)
          do iSh2 = 1, this%nShells(iSp2)
            this%shift1Deriv(iSh1, iAt1) = this%shift1Deriv(iSh1, iAt1)&
                & + this%gamma3abDeriv(iSh2, iSh1, iNeigh, iAt1) * this%chargesPerShell(iSh2, iAt2f)&
                & * this%chargesPerAtom(iAt1)
            this%shift2Deriv(iSh1, iAt1) = this%shift2Deriv(iSh1, iAt1)&
                & + this%gamma3baDeriv(iSh2, iSh1, iNeigh, iAt1) * this%chargesPerShell(iSh2, iAt2f)&
                & * this%chargesPerAtom(iAt2f)
            this%shift3Deriv(iAt1) = this%shift3Deriv(iAt1)&
                & + this%gamma3abDeriv(iSh2, iSh1, iNeigh, iAt1) * this%chargesPerShell(iSh2, iAt2f)&
                & * this%chargesPerShell(iSh1, iAt1)
            if (iAt2f /= iAt1) then
              this%shift1Deriv(iSh2, iAt2f) = this%shift1Deriv(iSh2, iAt2f)&
                  & + this%gamma3baDeriv(iSh2, iSh1, iNeigh, iAt1) * this%chargesPerShell(iSh1, iAt1)&
                  & * this%chargesPerAtom(iAt2f)
              this%shift2Deriv(iSh2, iAt2f) = this%shift2Deriv(iSh2, iAt2f)&
                  & + this%gamma3abDeriv(iSh2, iSh1, iNeigh, iAt1) * this%chargesPerShell(iSh1, iAt1)&
                  & * this%chargesPerAtom(iAt1)
              this%shift3Deriv(iAt2f) = this%shift3Deriv(iAt2f)&
                  & + this%gamma3baDeriv(iSh2, iSh1, iNeigh, iAt1) * this%chargesPerShell(iSh1, iAt1)&
                  & * this%chargesPerShell(iSh2, iAt2f)
            end if
          end do
  ...
  end subroutine updateChargesCP_backup
  ...
  subroutine updateChargesCP(this, species)
    ...
    do iAt1 = 1, this%nAtoms
      ...
      do iAt2 = 1, this%nAtoms
        ...
        do iSh1 = 1, this%nShells(iSp1)
          do iSh2 = 1, this%nShells(iSp2)
!           write (*,*) "adding to ", iSh1, iAt1
            this%shift1Deriv(iSh1, iAt1) = this%shift1Deriv(iSh1, iAt1)&
                & + this%gamma3abDeriv(iSh2, iSh1, iAt2, iAt1) * this%chargesPerShell(iSh2, iAt2)&
                & * this%chargesPerAtom(iAt1)
!           write (*,'(A,F12.6)') "add shift1d ", this%gamma3abDeriv(iSh2, iSh1, iAt2, iAt1) &
!               & * this%chargesPerShell(iSh2, iAt2) * this%chargesPerAtom(iAt1)
            this%shift2Deriv(iSh1, iAt1) = this%shift2Deriv(iSh1, iAt1)&
                & + this%gamma3baDeriv(iSh2, iSh1, iAt2, iAt1) * this%chargesPerShell(iSh2, iAt2)&
                & * this%chargesPerAtom(iAt2)
!           write (*,'(A,F12.6)') "add shift2d ",  this%gamma3baDeriv(iSh2, iSh1, iAt2, iAt1) &
!               & * this%chargesPerShell(iSh2, iAt2) * this%chargesPerAtom(iAt2)
            this%shift3Deriv(iAt1) = this%shift3Deriv(iAt1)&
                & + this%gamma3abDeriv(iSh2, iSh1, iAt2, iAt1) * this%chargesPerShell(iSh2, iAt2)&
                & * this%chargesPerShell(iSh1, iAt1)
!           write (*,'(A,F12.6)') "add shift3d ",  this%gamma3abDeriv(iSh2, iSh1, iAt2, iAt1) &
!               & * this%chargesPerShell(iSh2, iAt2) * this%chargesPerShell(iSh1, iAt1)
!           write (*,*) "adding to ", iSh2, iAt2
            this%shift1Deriv(iSh2, iAt2) = this%shift1Deriv(iSh2, iAt2)&
                ...
                & * this%chargesPerAtom(iAt2)
!           write (*,'(A,F12.6)') "add shift1d ", - this%gamma3baDeriv(iSh2, iSh1, iAt2, iAt1) &
!               & * this%chargesPerShell(iSh1, iAt1) * this%chargesPerAtom(iAt2)
            this%shift2Deriv(iSh2, iAt2) = this%shift2Deriv(iSh2, iAt2)&
                ...
                & * this%chargesPerAtom(iAt1)
!           write (*,'(A,F12.6)') "add shift2d ", - this%gamma3abDeriv(iSh2, iSh1, iAt2, iAt1) &
!               & * this%chargesPerShell(iSh1, iAt1) * this%chargesPerAtom(iAt1)
            this%shift3Deriv(iAt2) = this%shift3Deriv(iAt2)&
                & - this%gamma3baDeriv(iSh2, iSh1, iAt2, iAt1) * this%chargesPerShell(iSh1, iAt1)&
                & * this%chargesPerShell(iSh2, iAt2)
!           write (*,'(A,F12.6)') "add shift3d ", - this%gamma3baDeriv(iSh2, iSh1, iAt2, iAt1) &
!               & * this%chargesPerShell(iSh1, iAt1) * this%chargesPerShell(iSh2, iAt2)
          end do
        end do
      end do
    end do
  ...
  !> Returns shifts per atom.
  ! (Note: this is only used in Tomas' version of the forces)
