...
#:endif
  ...
  type(TTimerItem), parameter :: globalTimerItems(36) = [&
      ...
      & TTimerItem("Derivatives of atom charges", 2),&
  ...
  type :: TGlobalTimersHelper
    ...
    integer :: perturb = 23
    integer :: perturbQM = 24
    integer :: perturbMM = 25
    integer :: postGeoOpt = 26
    integer :: elecDynInit = 27
    integer :: elecDynLoop = 28
    integer :: lrExcitation = 29
    integer :: lrSetup = 30
    integer :: lrCoulomb = 31
    integer :: lrTransCharges = 32
    integer :: lrSolver = 33
    integer :: lrZVector = 34
    integer :: lrGradients = 35
    integer :: lrNAC = 36
