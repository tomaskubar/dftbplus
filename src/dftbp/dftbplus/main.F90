...
#:endif
  ...
  use dftbp_machinelearning, only : TMachineLearning
...
contains
  ...
  #:endif
    ...
    if (allocated(this%machineLearning)) then
      call env%globalTimer%startTimer(globalTimers%machLearnEnergy)
      this%dftbEnergy%EML = this%machineLearning%getEnergy(this%coord, this%img2CentCell)
    ...
    if (this%tForces) then
      ...
      if (allocated(this%reks)) then
        ...
        call getGradients(env, this%parallelKS, this%boundaryCond, this%scc, this%tblite,&
            ...
            & this%densityMatrix, this%machineLearning, errStatus)
        @:PROPAGATE_ERROR(errStatus)
...
#:endif
  ...
  subroutine getGradients(env, parallelKS, boundaryConds, sccCalc, tblite, isExtField, isXlbomd,&
      ...
      & tRealHS, kPoint, kWeight, densityMatrix, machineLearning, errStatus)
