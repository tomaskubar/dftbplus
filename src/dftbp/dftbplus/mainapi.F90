...
module dftbp_dftbplus_mainapi
  ...
  use dftbp_dftbplus_main, only : processGeometry, processChargeDerivatives
...
#:endif
  ...
  private
  public :: checkSpeciesNames, doOneTdStep, finalizeTimeProp, getAtomicMasses, getChargeDerivatives
  public :: getCM5Charges, getCutOff, getElStatPotential, getEnergy, getExtChargeGradients
  public :: getGradients, getGrossCharges, getLocalKS, getRefCharges, getStressTensor, getTdForces
  public :: initializeTimeProp, nrOfAtoms, nrOfExtCharges, nrOfKPoints, nrOfLocalKS, nrOfSpin
  public :: setElectronNumber, setExternalCharges, setExternalEfield, setExternalPotential, setGeometry
...
contains
  ...
  function nrOfExtCharges(main)
    ...
    !> Resulting count of external point charges
