...
#:endif
  ...
  type :: TDftbPlusMain
    ...
    !> Shall derivatives w.r.t. coordinates be evaluated?
...
contains
  ...
  #:endif
    ...
    if (this%isLinResp) then
      tRequireDerivator = (this%tForces .or. this%tXDerivs .or. input%ctrl%lrespini%tNaCoupling)
    else
      tRequireDerivator = this%tForces .or. this%tXDerivs
    end if
