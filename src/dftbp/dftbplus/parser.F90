...
contains
  ...
  #:else
    ...
    if (present(nExtCharge)) then
      call readHamiltonian(hamNode, input%ctrl, input%geom, input%slako, input%poisson, errStatus, nExtCharge)
    else
...
#:else
  subroutine readHamiltonian(node, ctrl, geo, slako, poisson, errStatus, nExtCharge)
#:endif
  ...
  #:else
      if (present(nExtCharge)) then
        call readDFTBHam(node, ctrl, geo, slako, poisson, errStatus, nExtCharge)
      else
...
#:else
  subroutine readDFTBHam(node, ctrl, geo, slako, poisson, errStatus, nExtCharge)
#:endif
