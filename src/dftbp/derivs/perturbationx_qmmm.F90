...
module dftbp_derivs_perturbxderivs_qmmm
      ...
      ! end if
        ...
        lpSCC: do while (iSCCiter <= maxSccIter)
          ...
          if (tSccCalc) then
            ...
            call addShift(env, sOmega(:,:), over, nNeighbourSK, neighbourList%iNeighbour, species,&
          ...
          do iS = 1, nSpin
            call mulliken(env, dqOut(:, :, iS, iCart, iExtChrgWRT), over, dRho(:,iS), orb,&
...
end module dftbp_derivs_perturbxderivs_qmmm
